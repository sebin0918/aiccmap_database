...
all_tables_df = [
    ...
    df_us_economic_indicator, df_main_economic_index, df_news,
]
...
# 데이터프레임 삽입/업데이트
insert_or_update_data(df_finance_date, database_tables_name[0], columns_finance_date, values_finance_date)
insert_or_update_data(df_stock, database_tables_name[1], columns_stock, values_stock)
insert_or_update_data(df_korea_economic_indicator, database_tables_name[2], columns_korea_economic_indicator, values_korea_economic_indicator)
insert_or_update_data(df_us_economic_indicator, database_tables_name[3], columns_us_economic_indicator, values_us_economic_indicator)
insert_or_update_data(df_main_economic_index, database_tables_name[4], columns_main_economic_index, values_main_economic_index)
insert_or_update_data(df_news, database_tables_name[5], columns_news, values_news)
